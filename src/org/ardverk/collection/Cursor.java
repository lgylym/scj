...
public interface Cursor<K, V> {
  ...
  /**
   * Called for each {@link java.util.Map.Entry} in the {@link Trie}. Return
   * {@link Decision#EXIT} to finish the {@link Trie} operation,
   * {@link Decision#CONTINUE} to go to the next {@link java.util.Map.Entry},
   * {@link Decision#REMOVE} to remove the {@link java.util.Map.Entry} and
