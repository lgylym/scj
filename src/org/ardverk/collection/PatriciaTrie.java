...
public class PatriciaTrie<K, V> extends AbstractPatriciaTrie<K, V> 
  ...
  private abstract class RangeMap extends AbstractMap<K, V> 
   ...
   /**
  * A {@link RangeMap} that deals with {@link java.util.Map.Entry}s
  */
  ...
  /**
   * A {@link java.util.Set} view of a {@link RangeMap}
   */
  private class RangeEntrySet extends AbstractSet<Entry<K, V>> {
    ...
    /**
     * An {@link java.util.Iterator} for {@link RangeEntrySet}s.
     */
  ...
  private final class PrefixRangeEntrySet extends RangeEntrySet {
    ...
    /**
     * An {@link java.util.Iterator} that holds a single {@link TrieEntry}.
     */
